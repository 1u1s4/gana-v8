...
- Depende parcialmente de `docs/plans/completado/gana-v8-multi-market-scoring-publishing-validation.md` para publisher multi-mercado.
...
- Plan relacionado: `docs/plans/completado/gana-v8-multi-market-scoring-publishing-validation.md`.
