...
- El plan activo que depende de este cierre es `docs/plans/falta/gana-v8-harness-verificacion-release-ops-y-runbooks.md`, que ahora toma estas senales durables como base operativa.
